...
def get_system_info():
    ...
    try:
        ...
        info["login_username"] = win32security.GetTokenInformation()
...
def create_gui():
    ...
    def upload_info():
        try:
            ...
            response = requests.post("http://systeminfo.leadchina.cn:80/gather_computer_info", json=data, headers=headers)
